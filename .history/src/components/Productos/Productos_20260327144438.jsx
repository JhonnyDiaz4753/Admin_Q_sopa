...
export default function Productos() {
  ...
  const loadProdIngredients = useCallback(async (prodId) => {
    setLoadingIngr(true);
    console.log(
      "[Ingredientes] Cargando ingredientes del producto id:",
      prodId,
    );
    try {
  ...
  const handleAddIngredient = async () => {
    ...
    const alreadyAdded = prodIngredients.some(
      (i) => String(i.id) === String(selectedIngredientId),
    );
    if (alreadyAdded) {
    ...
    console.log(
      "[Ingredientes] Añadiendo ingrediente — productoId:",
      editId,
      "| ingredientId:",
      ingredientId,
    );
  ...
  const handleRemoveIngredient = async (ingrId) => {
    console.log(
      "[Ingredientes] Eliminando ingrediente — productoId:",
      editId,
      "| ingredienteId:",
      ingrId,
    );
              ...
              {TABS.map((tab) => (
                ...
                >
                  ...
                  {tab === "ingredientes" && prodIngredients.length > 0 && (
                    <span className="prod-tab-badge">
                      {prodIngredients.length}
                    </span>
                  )}
                </button>
              ))}
            ...
            <div className="ingr-tab">
              ...
              {loadingIngr ? (
                <div className="ingr-loading">
                  <span className="material-symbols-outlined ingr-loading-icon">
                    hourglass_top
                  </span>
                  ...
                  {prodIngredients.map((ingr) => (
                    <li key={ingr.id} className="ingr-item">
                      <div className="ingr-info">
                        <span className="material-symbols-outlined ingr-icon">
                          grocery
                        </span>
                        <div>
